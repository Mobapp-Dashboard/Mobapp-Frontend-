...
stats_plots = dbc.Row(
    [
        ...
        dbc.Col([
            html.P("*Distances are calculated by euclidean distance, witch means that the road network are not used to this calculus and we have a substimation of the distances, velocity and acceleration."),
        ], md=6)
